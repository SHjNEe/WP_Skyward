...
function university_files()
{
  ...
  wp_enqueue_style('bootstrap-css', '//maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css');
  ...
  // Enqueue your main stylesheets
  wp_enqueue_style('university_main_styles', get_theme_file_uri('/build/style-index.css'));
  wp_enqueue_style('university_extra_styles', get_theme_file_uri('/build/index.css'));

  // Localize data for your JavaScript file
...
{
  $api['key'] = 'AIzaSyDekJTa_uCZuN8RDdAtLVW31eNkC3G0a1s';
  return $api;
}
